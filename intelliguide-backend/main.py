...
app = FastAPI(
    ...
    version="5.0.0" # Versiyonu güncelledik
)
...
# --- API Endpoint'leri (v2 OLARAK GÜNCELLENDİ) ---
...
@app.get("/")
def read_root():
    return {"message": "IntelliGuide Backend v5 - CACHE BUSTED & V2 ENDPOINTS"}
