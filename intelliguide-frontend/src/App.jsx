// package.json, vite.config.js, etc. remain the same.
// Only src/App.jsx needs to be updated.
...
// NOTE: Replace this with your actual Render backend URL
const API_URL = 'https://intelliguide-backend.onrender.com';
